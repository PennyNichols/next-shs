        ...
        return (
          <Card>
            <CardContent>
              ...
              <Alert severity="info">
                Employee-specific settings such as department assignments, shift scheduling, and training records will
                be available soon.
              </Alert>
        ...
        return (
          <Card>
            <CardContent>
              ...
              <Alert severity="info">
                Employee system preferences such as dashboard customization, default views, and workflow settings will
                be available soon.
              </Alert>
            </CardContent>
          </Card>
