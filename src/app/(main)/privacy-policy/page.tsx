...
export const metadata: Metadata = {
  ...
  description: 'Read the SHS Florida Privacy Policy to learn how we collect, use, and protect your personal information. Your privacy and security are our top priorities.',
  robots: 'index, follow',
  openGraph: {
    title: 'Privacy Policy | SHS Florida',
    description: 'Learn how SHS Florida collects, uses, and safeguards your information. Your privacy is important to us.',
    type: 'website',
  ...
  return (
    <PageContainer maxWidth="lg">
      <Box sx={{ mb: {xxs: 0, sm: 3} }}>
        <Typography id="privacy-policy-title" variant="h2" component="h1" sx={{fontSize: {xxs: '2rem', sm: '3rem'}}} tabIndex={-1}>
          Privacy Policy
        </Typography>
        <Typography variant="h5" align="center" id="privacy-policy-updated" sx={{ mb: { xxs: 0, sm: 1 }, fontSize: { xxs: '1.2rem', sm: '1.5rem'} }}>
        ...
        {sections
          ? sections.map((section, idx) => (
              ...
              >
                <Typography id={`privacy-policy-collect-${idx}`} variant="h3" component="h2" mb={2} sx={{ textAlign: {xxs: 'center', md: 'left'}}}>
                  {section.title}
                </Typography>
                ...
                {section.details
                  ? section.details.map((detail, detailIdx) => (
                      <Typography
                        key={detailIdx}
                        component="h3"
                        sx={{ fontWeight: 600, color: lightBlue }}
                      >
                        {detail.text}
        ...
        <Box>
          ...
          >
            ...
            >
              <Typography variant="h4" component="h3" className="contact-header" sx={{ mb: 1, width: 'fit-content', fontFamily: 'archivo', fontWeight: 800 }}>
                SHS Florida
              </Typography>
