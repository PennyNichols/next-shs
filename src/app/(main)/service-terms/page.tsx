...
import { darkText, mediumBlue } from '@/styles/theme/colors';
...
const TermsOfServicePage = () => {
  const { lastUpdated, intro, sections, acknowledgement } = SERVICE_TERMS;
  return (
    <PageContainer maxWidth="lg">
      ...
      {sections
        ...
        : null}
      <Typography sx={{ fontWeight: 600 }}>{acknowledgement}</Typography>
      <Box>
        <Box
          sx={{
            display: 'flex',
