...
const BlogForm = () => {
  ...
  const handleDetailChange = (e, itemIndex, detailIndex, arrayName) => {
    const { name, value } = e.target;
    const newArray = [...formData[arrayName]];
    newArray[itemIndex].details[detailIndex] = {
      ...newArray[itemIndex].details[detailIndex],
      [name]: value,
    };
    setFormData({ ...formData, [arrayName]: newArray });
  ...
  const addSubDetailToNumberedItem = (itemIndex, detailIndex) => {
    const newNumberedList = [...formData.numberedList];
    newNumberedList[itemIndex].details[detailIndex].subDetails.push({
      subDetailTitle: '',
      subDetailText: '',
    });
    setFormData({ ...formData, numberedList: newNumberedList });
  ...
  const removeSubDetailFromNumberedItem = (itemIndex, detailIndex, subDetailIndex) => {
    const newNumberedList = [...formData.numberedList];
    newNumberedList[itemIndex].details[detailIndex].subDetails = newNumberedList[itemIndex].details[
      detailIndex
    ].subDetails.filter((_, i) => i !== subDetailIndex);
    setFormData({ ...formData, numberedList: newNumberedList });
  };
  ...
  const addSubDetail = (index) => {
    ...
    newDetails[index].subDetails.push({
      subDetailTitle: '',
      subDetailText: '',
    });
    setFormData({ ...formData, details: newDetails });
