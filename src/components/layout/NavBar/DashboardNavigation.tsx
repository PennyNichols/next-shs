...
import { AccountCircle, BuildCircle, BuildCircleOutlined, Dashboard, DashboardOutlined } from '@mui/icons-material';
  ...
  return (
    <Toolbar>
      ...
      {accessibleDashboards.length > 1 && (
        <Box>
          <IconButton color="inherit" onClick={handleDashboardMenuOpen} title="Switch Dashboard" sx={{ p: 0, mr: 1 }}>
            <DashboardOutlined />
          </IconButton>
          <Menu
      ...
      {/* User Menu */}
      <IconButton size="large" edge="end" color="inherit" onClick={handleUserMenuOpen} sx={{ p: 0 }}>
        <BuildCircleOutlined />
      </IconButton>
      <Menu
        anchorEl={anchorEl}
